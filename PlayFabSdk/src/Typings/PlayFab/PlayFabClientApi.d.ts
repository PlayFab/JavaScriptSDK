...
declare module PlayFabClientModule {
    export interface IPlayFabClient {
         ...
         */
        LinkBattleNet(request: PlayFabClientModels.LinkBattleNetRequest, callback: PlayFabModule.ApiCallback<PlayFabClientModels.EmptyResponse>, customData?: any, extraHeaders?: { [key: string]: string }): Promise<PlayFabModule.ApiCallback<PlayFabClientModels.EmptyResponse>>;
        /**
         ...
         */
        UnlinkBattleNet(request: PlayFabClientModels.UnlinkBattleNetRequest, callback: PlayFabModule.ApiCallback<PlayFabClientModels.EmptyResponse>, customData?: any, extraHeaders?: { [key: string]: string }): Promise<PlayFabModule.ApiCallback<PlayFabClientModels.EmptyResponse>>;
        /**
