...
export interface IPlayFabClient {
     ...
     */
    AcceptTrade(request: AcceptTradeRequest, callback: PlayFabModule.ApiCallback<AcceptTradeResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    AddFriend(request: AddFriendRequest, callback: PlayFabModule.ApiCallback<AddFriendResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    AddGenericID(request: AddGenericIDRequest, callback: PlayFabModule.ApiCallback<AddGenericIDResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Adds or updates a contact email to the player's profile.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/addorupdatecontactemail
     */
    AddOrUpdateContactEmail(request: AddOrUpdateContactEmailRequest, callback: PlayFabModule.ApiCallback<AddOrUpdateContactEmailResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    AddSharedGroupMembers(request: AddSharedGroupMembersRequest, callback: PlayFabModule.ApiCallback<AddSharedGroupMembersResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Adds playfab username/password auth to an existing account created via an anonymous auth method, e.g. automatic device
     * ID login.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/addusernamepassword
     */
    AddUsernamePassword(request: AddUsernamePasswordRequest, callback: PlayFabModule.ApiCallback<AddUsernamePasswordResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Increments the user's balance of the specified virtual currency by the stated amount
     * https://docs.microsoft.com/rest/api/playfab/client/player-item-management/adduservirtualcurrency
     */
    AddUserVirtualCurrency(request: AddUserVirtualCurrencyRequest, callback: PlayFabModule.ApiCallback<ModifyUserVirtualCurrencyResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    AndroidDevicePushNotificationRegistration(request: AndroidDevicePushNotificationRegistrationRequest, callback: PlayFabModule.ApiCallback<AndroidDevicePushNotificationRegistrationResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Attributes an install for advertisment.
     * https://docs.microsoft.com/rest/api/playfab/client/advertising/attributeinstall
     */
    AttributeInstall(request: AttributeInstallRequest, callback: PlayFabModule.ApiCallback<AttributeInstallResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    CancelTrade(request: CancelTradeRequest, callback: PlayFabModule.ApiCallback<CancelTradeResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    ConfirmPurchase(request: ConfirmPurchaseRequest, callback: PlayFabModule.ApiCallback<ConfirmPurchaseResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Consume uses of a consumable item. When all uses are consumed, it will be removed from the player's inventory.
     * https://docs.microsoft.com/rest/api/playfab/client/player-item-management/consumeitem
     */
    ConsumeItem(request: ConsumeItemRequest, callback: PlayFabModule.ApiCallback<ConsumeItemResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Checks for any new consumable entitlements. If any are found, they are consumed and added as PlayFab items
     * https://docs.microsoft.com/rest/api/playfab/client/platform-specific-methods/consumepsnentitlements
     */
    ConsumePSNEntitlements(request: ConsumePSNEntitlementsRequest, callback: PlayFabModule.ApiCallback<ConsumePSNEntitlementsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    ConsumeXboxEntitlements(request: ConsumeXboxEntitlementsRequest, callback: PlayFabModule.ApiCallback<ConsumeXboxEntitlementsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    CreateSharedGroup(request: CreateSharedGroupRequest, callback: PlayFabModule.ApiCallback<CreateSharedGroupResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Executes a CloudScript function, with the 'currentPlayerId' set to the PlayFab ID of the authenticated player.
     * https://docs.microsoft.com/rest/api/playfab/client/server-side-cloud-script/executecloudscript
     */
    ExecuteCloudScript(request: ExecuteCloudScriptRequest, callback: PlayFabModule.ApiCallback<ExecuteCloudScriptResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the user's PlayFab account details
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/getaccountinfo
     */
    GetAccountInfo(request: GetAccountInfoRequest, callback: PlayFabModule.ApiCallback<GetAccountInfoResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetAdPlacements(request: GetAdPlacementsRequest, callback: PlayFabModule.ApiCallback<GetAdPlacementsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Lists all of the characters that belong to a specific user. CharacterIds are not globally unique; characterId must be
     * evaluated with the parent PlayFabId to guarantee uniqueness.
     * https://docs.microsoft.com/rest/api/playfab/client/characters/getalluserscharacters
     */
    GetAllUsersCharacters(request: ListUsersCharactersRequest, callback: PlayFabModule.ApiCallback<ListUsersCharactersResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the specified version of the title's catalog of virtual goods, including all defined properties
     * https://docs.microsoft.com/rest/api/playfab/client/title-wide-data-management/getcatalogitems
     */
    GetCatalogItems(request: GetCatalogItemsRequest, callback: PlayFabModule.ApiCallback<GetCatalogItemsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the title-specific custom data for the character which is readable and writable by the client
     * https://docs.microsoft.com/rest/api/playfab/client/character-data/getcharacterdata
     */
    GetCharacterData(request: GetCharacterDataRequest, callback: PlayFabModule.ApiCallback<GetCharacterDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the specified character's current inventory of virtual goods
     * https://docs.microsoft.com/rest/api/playfab/client/player-item-management/getcharacterinventory
     */
    GetCharacterInventory(request: GetCharacterInventoryRequest, callback: PlayFabModule.ApiCallback<GetCharacterInventoryResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves a list of ranked characters for the given statistic, starting from the indicated point in the leaderboard
     * https://docs.microsoft.com/rest/api/playfab/client/characters/getcharacterleaderboard
     */
    GetCharacterLeaderboard(request: GetCharacterLeaderboardRequest, callback: PlayFabModule.ApiCallback<GetCharacterLeaderboardResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the title-specific custom data for the character which can only be read by the client
     * https://docs.microsoft.com/rest/api/playfab/client/character-data/getcharacterreadonlydata
     */
    GetCharacterReadOnlyData(request: GetCharacterDataRequest, callback: PlayFabModule.ApiCallback<GetCharacterDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the details of all title-specific statistics for the user
     * https://docs.microsoft.com/rest/api/playfab/client/characters/getcharacterstatistics
     */
    GetCharacterStatistics(request: GetCharacterStatisticsRequest, callback: PlayFabModule.ApiCallback<GetCharacterStatisticsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetContentDownloadUrl(request: GetContentDownloadUrlRequest, callback: PlayFabModule.ApiCallback<GetContentDownloadUrlResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Get details about all current running game servers matching the given parameters.
     * https://docs.microsoft.com/rest/api/playfab/client/matchmaking/getcurrentgames
     */
    GetCurrentGames(request: CurrentGamesRequest, callback: PlayFabModule.ApiCallback<CurrentGamesResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves a list of ranked friends of the current player for the given statistic, starting from the indicated point in
     * the leaderboard
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/getfriendleaderboard
     */
    GetFriendLeaderboard(request: GetFriendLeaderboardRequest, callback: PlayFabModule.ApiCallback<GetLeaderboardResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetFriendLeaderboardAroundPlayer(request: GetFriendLeaderboardAroundPlayerRequest, callback: PlayFabModule.ApiCallback<GetFriendLeaderboardAroundPlayerResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetFriendsList(request: GetFriendsListRequest, callback: PlayFabModule.ApiCallback<GetFriendsListResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Get details about the regions hosting game servers matching the given parameters.
     * https://docs.microsoft.com/rest/api/playfab/client/matchmaking/getgameserverregions
     */
    GetGameServerRegions(request: GameServerRegionsRequest, callback: PlayFabModule.ApiCallback<GameServerRegionsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves a list of ranked users for the given statistic, starting from the indicated point in the leaderboard
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/getleaderboard
     */
    GetLeaderboard(request: GetLeaderboardRequest, callback: PlayFabModule.ApiCallback<GetLeaderboardResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves a list of ranked characters for the given statistic, centered on the requested Character ID
     * https://docs.microsoft.com/rest/api/playfab/client/characters/getleaderboardaroundcharacter
     */
    GetLeaderboardAroundCharacter(request: GetLeaderboardAroundCharacterRequest, callback: PlayFabModule.ApiCallback<GetLeaderboardAroundCharacterResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetLeaderboardAroundPlayer(request: GetLeaderboardAroundPlayerRequest, callback: PlayFabModule.ApiCallback<GetLeaderboardAroundPlayerResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves a list of all of the user's characters for the given statistic.
     * https://docs.microsoft.com/rest/api/playfab/client/characters/getleaderboardforusercharacters
     */
    GetLeaderboardForUserCharacters(request: GetLeaderboardForUsersCharactersRequest, callback: PlayFabModule.ApiCallback<GetLeaderboardForUsersCharactersResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPaymentToken(request: GetPaymentTokenRequest, callback: PlayFabModule.ApiCallback<GetPaymentTokenResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPhotonAuthenticationToken(request: GetPhotonAuthenticationTokenRequest, callback: PlayFabModule.ApiCallback<GetPhotonAuthenticationTokenResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves all of the user's different kinds of info.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/getplayercombinedinfo
     */
    GetPlayerCombinedInfo(request: GetPlayerCombinedInfoRequest, callback: PlayFabModule.ApiCallback<GetPlayerCombinedInfoResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the player's profile
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/getplayerprofile
     */
    GetPlayerProfile(request: GetPlayerProfileRequest, callback: PlayFabModule.ApiCallback<GetPlayerProfileResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * List all segments that a player currently belongs to at this moment in time.
     * https://docs.microsoft.com/rest/api/playfab/client/playstream/getplayersegments
     */
    GetPlayerSegments(request: GetPlayerSegmentsRequest, callback: PlayFabModule.ApiCallback<GetPlayerSegmentsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the indicated statistics (current version and values for all statistics, if none are specified), for the local
     * player.
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/getplayerstatistics
     */
    GetPlayerStatistics(request: GetPlayerStatisticsRequest, callback: PlayFabModule.ApiCallback<GetPlayerStatisticsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the information on the available versions of the specified statistic.
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/getplayerstatisticversions
     */
    GetPlayerStatisticVersions(request: GetPlayerStatisticVersionsRequest, callback: PlayFabModule.ApiCallback<GetPlayerStatisticVersionsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Get all tags with a given Namespace (optional) from a player profile.
     * https://docs.microsoft.com/rest/api/playfab/client/playstream/getplayertags
     */
    GetPlayerTags(request: GetPlayerTagsRequest, callback: PlayFabModule.ApiCallback<GetPlayerTagsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Gets all trades the player has either opened or accepted, optionally filtered by trade status.
     * https://docs.microsoft.com/rest/api/playfab/client/trading/getplayertrades
     */
    GetPlayerTrades(request: GetPlayerTradesRequest, callback: PlayFabModule.ApiCallback<GetPlayerTradesResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the unique PlayFab identifiers for the given set of Facebook identifiers.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/getplayfabidsfromfacebookids
     */
    GetPlayFabIDsFromFacebookIDs(request: GetPlayFabIDsFromFacebookIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromFacebookIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPlayFabIDsFromFacebookInstantGamesIds(request: GetPlayFabIDsFromFacebookInstantGamesIdsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromFacebookInstantGamesIdsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPlayFabIDsFromGameCenterIDs(request: GetPlayFabIDsFromGameCenterIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromGameCenterIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPlayFabIDsFromGenericIDs(request: GetPlayFabIDsFromGenericIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromGenericIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPlayFabIDsFromGoogleIDs(request: GetPlayFabIDsFromGoogleIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromGoogleIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPlayFabIDsFromKongregateIDs(request: GetPlayFabIDsFromKongregateIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromKongregateIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPlayFabIDsFromNintendoSwitchDeviceIds(request: GetPlayFabIDsFromNintendoSwitchDeviceIdsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromNintendoSwitchDeviceIdsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the unique PlayFab identifiers for the given set of PlayStation Network identifiers.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/getplayfabidsfrompsnaccountids
     */
    GetPlayFabIDsFromPSNAccountIDs(request: GetPlayFabIDsFromPSNAccountIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromPSNAccountIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPlayFabIDsFromSteamIDs(request: GetPlayFabIDsFromSteamIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromSteamIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPlayFabIDsFromTwitchIDs(request: GetPlayFabIDsFromTwitchIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromTwitchIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the unique PlayFab identifiers for the given set of XboxLive identifiers.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/getplayfabidsfromxboxliveids
     */
    GetPlayFabIDsFromXboxLiveIDs(request: GetPlayFabIDsFromXboxLiveIDsRequest, callback: PlayFabModule.ApiCallback<GetPlayFabIDsFromXboxLiveIDsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the key-value store of custom publisher settings
     * https://docs.microsoft.com/rest/api/playfab/client/title-wide-data-management/getpublisherdata
     */
    GetPublisherData(request: GetPublisherDataRequest, callback: PlayFabModule.ApiCallback<GetPublisherDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetPurchase(request: GetPurchaseRequest, callback: PlayFabModule.ApiCallback<GetPurchaseResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    GetSharedGroupData(request: GetSharedGroupDataRequest, callback: PlayFabModule.ApiCallback<GetSharedGroupDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the set of items defined for the specified store, including all prices defined
     * https://docs.microsoft.com/rest/api/playfab/client/title-wide-data-management/getstoreitems
     */
    GetStoreItems(request: GetStoreItemsRequest, callback: PlayFabModule.ApiCallback<GetStoreItemsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the current server time
     * https://docs.microsoft.com/rest/api/playfab/client/title-wide-data-management/gettime
     */
    GetTime(request: GetTimeRequest, callback: PlayFabModule.ApiCallback<GetTimeResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the key-value store of custom title settings
     * https://docs.microsoft.com/rest/api/playfab/client/title-wide-data-management/gettitledata
     */
    GetTitleData(request: GetTitleDataRequest, callback: PlayFabModule.ApiCallback<GetTitleDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the title news feed, as configured in the developer portal
     * https://docs.microsoft.com/rest/api/playfab/client/title-wide-data-management/gettitlenews
     */
    GetTitleNews(request: GetTitleNewsRequest, callback: PlayFabModule.ApiCallback<GetTitleNewsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Returns the title's base 64 encoded RSA CSP blob.
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/gettitlepublickey
     */
    GetTitlePublicKey(request: GetTitlePublicKeyRequest, callback: PlayFabModule.ApiCallback<GetTitlePublicKeyResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Gets the current status of an existing trade.
     * https://docs.microsoft.com/rest/api/playfab/client/trading/gettradestatus
     */
    GetTradeStatus(request: GetTradeStatusRequest, callback: PlayFabModule.ApiCallback<GetTradeStatusResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the title-specific custom data for the user which is readable and writable by the client
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/getuserdata
     */
    GetUserData(request: GetUserDataRequest, callback: PlayFabModule.ApiCallback<GetUserDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the user's current inventory of virtual goods
     * https://docs.microsoft.com/rest/api/playfab/client/player-item-management/getuserinventory
     */
    GetUserInventory(request: GetUserInventoryRequest, callback: PlayFabModule.ApiCallback<GetUserInventoryResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the publisher-specific custom data for the user which is readable and writable by the client
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/getuserpublisherdata
     */
    GetUserPublisherData(request: GetUserDataRequest, callback: PlayFabModule.ApiCallback<GetUserDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the publisher-specific custom data for the user which can only be read by the client
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/getuserpublisherreadonlydata
     */
    GetUserPublisherReadOnlyData(request: GetUserDataRequest, callback: PlayFabModule.ApiCallback<GetUserDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Retrieves the title-specific custom data for the user which can only be read by the client
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/getuserreadonlydata
     */
    GetUserReadOnlyData(request: GetUserDataRequest, callback: PlayFabModule.ApiCallback<GetUserDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Requests a challenge from the server to be signed by Windows Hello Passport service to authenticate.
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/getwindowshellochallenge
     */
    GetWindowsHelloChallenge(request: GetWindowsHelloChallengeRequest, callback: PlayFabModule.ApiCallback<GetWindowsHelloChallengeResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Grants the specified character type to the user. CharacterIds are not globally unique; characterId must be evaluated
     * with the parent PlayFabId to guarantee uniqueness.
     * https://docs.microsoft.com/rest/api/playfab/client/characters/grantcharactertouser
     */
    GrantCharacterToUser(request: GrantCharacterToUserRequest, callback: PlayFabModule.ApiCallback<GrantCharacterToUserResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the Android device identifier to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkandroiddeviceid
     */
    LinkAndroidDeviceID(request: LinkAndroidDeviceIDRequest, callback: PlayFabModule.ApiCallback<LinkAndroidDeviceIDResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LinkApple(request: LinkAppleRequest, callback: PlayFabModule.ApiCallback<EmptyResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the custom identifier, generated by the title, to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkcustomid
     */
    LinkCustomID(request: LinkCustomIDRequest, callback: PlayFabModule.ApiCallback<LinkCustomIDResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the Facebook account associated with the provided Facebook access token to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkfacebookaccount
     */
    LinkFacebookAccount(request: LinkFacebookAccountRequest, callback: PlayFabModule.ApiCallback<LinkFacebookAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the Facebook Instant Games Id to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkfacebookinstantgamesid
     */
    LinkFacebookInstantGamesId(request: LinkFacebookInstantGamesIdRequest, callback: PlayFabModule.ApiCallback<LinkFacebookInstantGamesIdResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the Game Center account associated with the provided Game Center ID to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkgamecenteraccount
     */
    LinkGameCenterAccount(request: LinkGameCenterAccountRequest, callback: PlayFabModule.ApiCallback<LinkGameCenterAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the currently signed-in user account to their Google account, using their Google account credentials
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkgoogleaccount
     */
    LinkGoogleAccount(request: LinkGoogleAccountRequest, callback: PlayFabModule.ApiCallback<LinkGoogleAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the vendor-specific iOS device identifier to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkiosdeviceid
     */
    LinkIOSDeviceID(request: LinkIOSDeviceIDRequest, callback: PlayFabModule.ApiCallback<LinkIOSDeviceIDResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the Kongregate identifier to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkkongregate
     */
    LinkKongregate(request: LinkKongregateAccountRequest, callback: PlayFabModule.ApiCallback<LinkKongregateAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LinkNintendoSwitchAccount(request: LinkNintendoSwitchAccountRequest, callback: PlayFabModule.ApiCallback<EmptyResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the NintendoSwitchDeviceId to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linknintendoswitchdeviceid
     */
    LinkNintendoSwitchDeviceId(request: LinkNintendoSwitchDeviceIdRequest, callback: PlayFabModule.ApiCallback<LinkNintendoSwitchDeviceIdResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LinkOpenIdConnect(request: LinkOpenIdConnectRequest, callback: PlayFabModule.ApiCallback<EmptyResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the PlayStation Network account associated with the provided access code to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkpsnaccount
     */
    LinkPSNAccount(request: LinkPSNAccountRequest, callback: PlayFabModule.ApiCallback<LinkPSNAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the Steam account associated with the provided Steam authentication ticket to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linksteamaccount
     */
    LinkSteamAccount(request: LinkSteamAccountRequest, callback: PlayFabModule.ApiCallback<LinkSteamAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the Twitch account associated with the token to the user's PlayFab account.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linktwitch
     */
    LinkTwitch(request: LinkTwitchAccountRequest, callback: PlayFabModule.ApiCallback<LinkTwitchAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LinkWindowsHello(request: LinkWindowsHelloAccountRequest, callback: PlayFabModule.ApiCallback<LinkWindowsHelloAccountResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Links the Xbox Live account associated with the provided access code to the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/linkxboxaccount
     */
    LinkXboxAccount(request: LinkXboxAccountRequest, callback: PlayFabModule.ApiCallback<LinkXboxAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Signs the user in using the Android device identifier, returning a session identifier that can subsequently be used for
     * API calls which require an authenticated user
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/loginwithandroiddeviceid
     */
    LoginWithAndroidDeviceID(request: LoginWithAndroidDeviceIDRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithApple(request: LoginWithAppleRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Signs the user in using a custom unique identifier generated by the title, returning a session identifier that can
     * subsequently be used for API calls which require an authenticated user
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/loginwithcustomid
     */
    LoginWithCustomID(request: LoginWithCustomIDRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithEmailAddress(request: LoginWithEmailAddressRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithFacebook(request: LoginWithFacebookRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithFacebookInstantGamesId(request: LoginWithFacebookInstantGamesIdRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithGameCenter(request: LoginWithGameCenterRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Signs the user in using their Google account credentials
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/loginwithgoogleaccount
     */
    LoginWithGoogleAccount(request: LoginWithGoogleAccountRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Signs the user in using the vendor-specific iOS device identifier, returning a session identifier that can subsequently
     * be used for API calls which require an authenticated user
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/loginwithiosdeviceid
     */
    LoginWithIOSDeviceID(request: LoginWithIOSDeviceIDRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Signs the user in using a Kongregate player account.
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/loginwithkongregate
     */
    LoginWithKongregate(request: LoginWithKongregateRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithNintendoSwitchAccount(request: LoginWithNintendoSwitchAccountRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithNintendoSwitchDeviceId(request: LoginWithNintendoSwitchDeviceIdRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithOpenIdConnect(request: LoginWithOpenIdConnectRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Signs the user into the PlayFab account, returning a session identifier that can subsequently be used for API calls
     ...
     */
    LoginWithPlayFab(request: LoginWithPlayFabRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithPSN(request: LoginWithPSNRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Signs the user in using a Steam authentication ticket, returning a session identifier that can subsequently be used for
     * API calls which require an authenticated user
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/loginwithsteam
     */
    LoginWithSteam(request: LoginWithSteamRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Signs the user in using a Twitch access token.
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/loginwithtwitch
     */
    LoginWithTwitch(request: LoginWithTwitchRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithWindowsHello(request: LoginWithWindowsHelloRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    LoginWithXbox(request: LoginWithXboxRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    Matchmake(request: MatchmakeRequest, callback: PlayFabModule.ApiCallback<MatchmakeResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Opens a new outstanding trade. Note that a given item instance may only be in one open trade at a time.
     * https://docs.microsoft.com/rest/api/playfab/client/trading/opentrade
     */
    OpenTrade(request: OpenTradeRequest, callback: PlayFabModule.ApiCallback<OpenTradeResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Selects a payment option for purchase order created via StartPurchase
     * https://docs.microsoft.com/rest/api/playfab/client/player-item-management/payforpurchase
     */
    PayForPurchase(request: PayForPurchaseRequest, callback: PlayFabModule.ApiCallback<PayForPurchaseResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    PurchaseItem(request: PurchaseItemRequest, callback: PlayFabModule.ApiCallback<PurchaseItemResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Adds the virtual goods associated with the coupon to the user's inventory. Coupons can be generated via the
     * Economy->Catalogs tab in the PlayFab Game Manager.
     * https://docs.microsoft.com/rest/api/playfab/client/player-item-management/redeemcoupon
     */
    RedeemCoupon(request: RedeemCouponRequest, callback: PlayFabModule.ApiCallback<RedeemCouponResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Uses the supplied OAuth code to refresh the internally cached player PSN auth token
     * https://docs.microsoft.com/rest/api/playfab/client/platform-specific-methods/refreshpsnauthtoken
     */
    RefreshPSNAuthToken(request: RefreshPSNAuthTokenRequest, callback: PlayFabModule.ApiCallback<EmptyResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Registers the iOS device to receive push notifications
     * https://docs.microsoft.com/rest/api/playfab/client/platform-specific-methods/registerforiospushnotification
     */
    RegisterForIOSPushNotification(request: RegisterForIOSPushNotificationRequest, callback: PlayFabModule.ApiCallback<RegisterForIOSPushNotificationResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    RegisterPlayFabUser(request: RegisterPlayFabUserRequest, callback: PlayFabModule.ApiCallback<RegisterPlayFabUserResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    RegisterWithWindowsHello(request: RegisterWithWindowsHelloRequest, callback: PlayFabModule.ApiCallback<LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Removes a contact email from the player's profile.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/removecontactemail
     */
    RemoveContactEmail(request: RemoveContactEmailRequest, callback: PlayFabModule.ApiCallback<RemoveContactEmailResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Removes a specified user from the friend list of the local user
     * https://docs.microsoft.com/rest/api/playfab/client/friend-list-management/removefriend
     */
    RemoveFriend(request: RemoveFriendRequest, callback: PlayFabModule.ApiCallback<RemoveFriendResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Removes the specified generic service identifier from the player's PlayFab account.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/removegenericid
     */
    RemoveGenericID(request: RemoveGenericIDRequest, callback: PlayFabModule.ApiCallback<RemoveGenericIDResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    RemoveSharedGroupMembers(request: RemoveSharedGroupMembersRequest, callback: PlayFabModule.ApiCallback<RemoveSharedGroupMembersResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Report player's ad activity
     * https://docs.microsoft.com/rest/api/playfab/client/advertising/reportadactivity
     */
    ReportAdActivity(request: ReportAdActivityRequest, callback: PlayFabModule.ApiCallback<ReportAdActivityResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Write a PlayStream event to describe the provided player device information. This API method is not designed to be
     * called directly by developers. Each PlayFab client SDK will eventually report this information automatically.
     * https://docs.microsoft.com/rest/api/playfab/client/analytics/reportdeviceinfo
     */
    ReportDeviceInfo(request: DeviceInfoRequest, callback: PlayFabModule.ApiCallback<EmptyResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Submit a report for another player (due to bad bahavior, etc.), so that customer service representatives for the title
     * can take action concerning potentially toxic players.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/reportplayer
     */
    ReportPlayer(request: ReportPlayerClientRequest, callback: PlayFabModule.ApiCallback<ReportPlayerClientResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Restores all in-app purchases based on the given restore receipt
     * https://docs.microsoft.com/rest/api/playfab/client/platform-specific-methods/restoreiospurchases
     */
    RestoreIOSPurchases(request: RestoreIOSPurchasesRequest, callback: PlayFabModule.ApiCallback<RestoreIOSPurchasesResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Reward player's ad activity
     * https://docs.microsoft.com/rest/api/playfab/client/advertising/rewardadactivity
     */
    RewardAdActivity(request: RewardAdActivityRequest, callback: PlayFabModule.ApiCallback<RewardAdActivityResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    SendAccountRecoveryEmail(request: SendAccountRecoveryEmailRequest, callback: PlayFabModule.ApiCallback<SendAccountRecoveryEmailResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Updates the tag list for a specified user in the friend list of the local user
     * https://docs.microsoft.com/rest/api/playfab/client/friend-list-management/setfriendtags
     */
    SetFriendTags(request: SetFriendTagsRequest, callback: PlayFabModule.ApiCallback<SetFriendTagsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Sets the player's secret if it is not already set. Player secrets are used to sign API requests. To reset a player's
     * secret use the Admin or Server API method SetPlayerSecret.
     * https://docs.microsoft.com/rest/api/playfab/client/authentication/setplayersecret
     */
    SetPlayerSecret(request: SetPlayerSecretRequest, callback: PlayFabModule.ApiCallback<SetPlayerSecretResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Start a new game server with a given configuration, add the current player and return the connection information.
     * https://docs.microsoft.com/rest/api/playfab/client/matchmaking/startgame
     */
    StartGame(request: StartGameRequest, callback: PlayFabModule.ApiCallback<StartGameResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Creates an order for a list of items from the title catalog
     * https://docs.microsoft.com/rest/api/playfab/client/player-item-management/startpurchase
     */
    StartPurchase(request: StartPurchaseRequest, callback: PlayFabModule.ApiCallback<StartPurchaseResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    SubtractUserVirtualCurrency(request: SubtractUserVirtualCurrencyRequest, callback: PlayFabModule.ApiCallback<ModifyUserVirtualCurrencyResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related Android device identifier from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkandroiddeviceid
     */
    UnlinkAndroidDeviceID(request: UnlinkAndroidDeviceIDRequest, callback: PlayFabModule.ApiCallback<UnlinkAndroidDeviceIDResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UnlinkApple(request: UnlinkAppleRequest, callback: PlayFabModule.ApiCallback<EmptyResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related custom identifier from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkcustomid
     */
    UnlinkCustomID(request: UnlinkCustomIDRequest, callback: PlayFabModule.ApiCallback<UnlinkCustomIDResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related Facebook account from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkfacebookaccount
     */
    UnlinkFacebookAccount(request: UnlinkFacebookAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkFacebookAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related Facebook Instant Game Ids from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkfacebookinstantgamesid
     */
    UnlinkFacebookInstantGamesId(request: UnlinkFacebookInstantGamesIdRequest, callback: PlayFabModule.ApiCallback<UnlinkFacebookInstantGamesIdResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related Game Center account from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkgamecenteraccount
     */
    UnlinkGameCenterAccount(request: UnlinkGameCenterAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkGameCenterAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UnlinkGoogleAccount(request: UnlinkGoogleAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkGoogleAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related iOS device identifier from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkiosdeviceid
     */
    UnlinkIOSDeviceID(request: UnlinkIOSDeviceIDRequest, callback: PlayFabModule.ApiCallback<UnlinkIOSDeviceIDResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related Kongregate identifier from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkkongregate
     */
    UnlinkKongregate(request: UnlinkKongregateAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkKongregateAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UnlinkNintendoSwitchAccount(request: UnlinkNintendoSwitchAccountRequest, callback: PlayFabModule.ApiCallback<EmptyResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related NintendoSwitchDeviceId from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinknintendoswitchdeviceid
     */
    UnlinkNintendoSwitchDeviceId(request: UnlinkNintendoSwitchDeviceIdRequest, callback: PlayFabModule.ApiCallback<UnlinkNintendoSwitchDeviceIdResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UnlinkOpenIdConnect(request: UnlinkOpenIdConnectRequest, callback: PlayFabModule.ApiCallback<EmptyResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related PSN account from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkpsnaccount
     */
    UnlinkPSNAccount(request: UnlinkPSNAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkPSNAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related Steam account from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinksteamaccount
     */
    UnlinkSteamAccount(request: UnlinkSteamAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkSteamAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related Twitch account from the user's PlayFab account.
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinktwitch
     */
    UnlinkTwitch(request: UnlinkTwitchAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkTwitchAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlink Windows Hello authentication from the current PlayFab Account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkwindowshello
     */
    UnlinkWindowsHello(request: UnlinkWindowsHelloAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkWindowsHelloAccountResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Unlinks the related Xbox Live account from the user's PlayFab account
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/unlinkxboxaccount
     */
    UnlinkXboxAccount(request: UnlinkXboxAccountRequest, callback: PlayFabModule.ApiCallback<UnlinkXboxAccountResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UnlockContainerInstance(request: UnlockContainerInstanceRequest, callback: PlayFabModule.ApiCallback<UnlockContainerItemResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UnlockContainerItem(request: UnlockContainerItemRequest, callback: PlayFabModule.ApiCallback<UnlockContainerItemResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Update the avatar URL of the player
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/updateavatarurl
     */
    UpdateAvatarUrl(request: UpdateAvatarUrlRequest, callback: PlayFabModule.ApiCallback<EmptyResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Creates and updates the title-specific custom data for the user's character which is readable and writable by the client
     * https://docs.microsoft.com/rest/api/playfab/client/character-data/updatecharacterdata
     */
    UpdateCharacterData(request: UpdateCharacterDataRequest, callback: PlayFabModule.ApiCallback<UpdateCharacterDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UpdateCharacterStatistics(request: UpdateCharacterStatisticsRequest, callback: PlayFabModule.ApiCallback<UpdateCharacterStatisticsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UpdatePlayerStatistics(request: UpdatePlayerStatisticsRequest, callback: PlayFabModule.ApiCallback<UpdatePlayerStatisticsResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    UpdateSharedGroupData(request: UpdateSharedGroupDataRequest, callback: PlayFabModule.ApiCallback<UpdateSharedGroupDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Creates and updates the title-specific custom data for the user which is readable and writable by the client
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/updateuserdata
     */
    UpdateUserData(request: UpdateUserDataRequest, callback: PlayFabModule.ApiCallback<UpdateUserDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Creates and updates the publisher-specific custom data for the user which is readable and writable by the client
     * https://docs.microsoft.com/rest/api/playfab/client/player-data-management/updateuserpublisherdata
     */
    UpdateUserPublisherData(request: UpdateUserDataRequest, callback: PlayFabModule.ApiCallback<UpdateUserDataResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Updates the title specific display name for the user
     * https://docs.microsoft.com/rest/api/playfab/client/account-management/updateusertitledisplayname
     */
    UpdateUserTitleDisplayName(request: UpdateUserTitleDisplayNameRequest, callback: PlayFabModule.ApiCallback<UpdateUserTitleDisplayNameResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    ValidateAmazonIAPReceipt(request: ValidateAmazonReceiptRequest, callback: PlayFabModule.ApiCallback<ValidateAmazonReceiptResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Validates a Google Play purchase and gives the corresponding item to the player.
     * https://docs.microsoft.com/rest/api/playfab/client/platform-specific-methods/validategoogleplaypurchase
     */
    ValidateGooglePlayPurchase(request: ValidateGooglePlayPurchaseRequest, callback: PlayFabModule.ApiCallback<ValidateGooglePlayPurchaseResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    ValidateIOSReceipt(request: ValidateIOSReceiptRequest, callback: PlayFabModule.ApiCallback<ValidateIOSReceiptResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     ...
     */
    ValidateWindowsStoreReceipt(request: ValidateWindowsReceiptRequest, callback: PlayFabModule.ApiCallback<ValidateWindowsReceiptResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Writes a character-based event into PlayStream.
     * https://docs.microsoft.com/rest/api/playfab/client/analytics/writecharacterevent
     */
    WriteCharacterEvent(request: WriteClientCharacterEventRequest, callback: PlayFabModule.ApiCallback<WriteEventResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Writes a player-based event into PlayStream.
     * https://docs.microsoft.com/rest/api/playfab/client/analytics/writeplayerevent
     */
    WritePlayerEvent(request: WriteClientPlayerEventRequest, callback: PlayFabModule.ApiCallback<WriteEventResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
    /**
     * Writes a title-based event into PlayStream.
     * https://docs.microsoft.com/rest/api/playfab/client/analytics/writetitleevent
     */
    WriteTitleEvent(request: WriteTitleEventRequest, callback: PlayFabModule.ApiCallback<WriteEventResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
